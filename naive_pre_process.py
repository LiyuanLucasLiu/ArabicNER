...
if __name__ == "__main__":
    ...
    parser.add_argument('--file_input', default="./config/ner0.json")
    parser.add_argument('--file_output', default="./config/ner0.json")
    ...
    for input_file, save_to in zip([conf.file_input], [conf.file_output]):
